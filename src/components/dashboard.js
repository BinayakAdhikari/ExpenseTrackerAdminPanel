...
export default function Dashboard() {
    ...
    const [shouldShowAddBankModal, setShouldShowAddBankModal] = useState(false);
    ...
    const handleAddition = (action) => {
        setSelectedAction(action);
        setShouldShowAddBankModal(true);
    }
            ...
            return <>
                <div className="container">
                    <tr>
                        ...
                        <td><button type='button' name='Delete' onClick={() => handleAddition('addBank')}>Add New</button></td>
                    ...
                    <tr>
                        ...
                        <td><button type='button' name='Delete' onClick={() => handleAddition('addKeyword')}>Add New</button></td>
                ...
                {shouldShowAddBankModal && <AddBanksModal action={selectedAction} setShouldShowAddBankModal={setShouldShowAddBankModal} shouldShowAddBankModal={shouldShowAddBankModal} />}
            </>
        } else {
            return <p>Loading.....</p>
        }
